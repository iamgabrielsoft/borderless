<template>
      <footer class="relative bg-zinc-900  text-zinc-10">
      <div class="container md:mx-auto sm:px-4 py-14 text-center">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mt-10">
          <div class="">
            <span class="block">Lorem ipsum dolor sit amet consectetur, mollitia facilis deserunt molestiae facere laudantium?</span>
          </div>

          <div class="px-5 mt-5">
            <ul class="flex gap-4 sm:justify-center">
              <li>
                <a href="#">Services</a>
              </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between mt-10">
          ...
          <div class="">
            <h2 class="leading-2 text-2xl text-zinc-10">NewsLetter</h2>
            <small>Get better news</small>
            <form class="mt-5">
